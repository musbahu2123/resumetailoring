// app/blog/[slug]/BlogPostClient.tsx - FIXED CLIENT COMPONENT
"use client";
...
export default function BlogPostClient({ post }: BlogPostClientProps) {
  ...
  // The manual JSON-LD injection useEffect has been removed as per instruction.

...
    sidebarY = addSkillsSidebarSection( // NEW: Use specialized skills renderer
      doc,
      'SKILLS',
      skillSections,
      margin + 3,
...
  const shouldUseCommaFormat = sections.some(section => 
...
    // Limit skills to 12 items max instead of 8
